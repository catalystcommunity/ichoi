...
class SessionAsyncClient:
    ...
    async def delete_account(self, req: DeleteAccountRequest) -> Ok:
        """delete-account"""
        return Ok.from_cbor(await self._transport.call("SessionService", "delete-account", req.to_cbor()))
...
class LibraryAsyncClient:
    ...
    async def export_manifest(self, req: ExportManifestRequest) -> ExportManifest:
        """export-manifest"""
        return ExportManifest.from_cbor(await self._transport.call("LibraryService", "export-manifest", req.to_cbor()))

    async def export_chunk(self, req: ExportChunkRequest) -> ExportChunk:
        """export-chunk"""
        return ExportChunk.from_cbor(await self._transport.call("LibraryService", "export-chunk", req.to_cbor()))
    ...
    async def delete_playlist(self, req: DeletePlaylistRequest) -> Ok:
        """delete-playlist"""
        return Ok.from_cbor(await self._transport.call("LibraryService", "delete-playlist", req.to_cbor()))
    ...
    async def report_content(self, req: ReportContentRequest) -> ContentReport:
        """report-content"""
        return ContentReport.from_cbor(await self._transport.call("LibraryService", "report-content", req.to_cbor()))
...
class AdminAsyncClient:
    ...
    async def delete_account(self, req: AdminDeleteAccountRequest) -> Ok:
        """delete-account"""
        return Ok.from_cbor(await self._transport.call("AdminService", "delete-account", req.to_cbor()))
    ...
    async def begin_import(self, req: BeginImportRequest) -> BeginImportResult:
        """begin-import"""
        return BeginImportResult.from_cbor(await self._transport.call("AdminService", "begin-import", req.to_cbor()))

    async def import_chunk(self, req: ImportChunkRequest) -> Ok:
        """import-chunk"""
        return Ok.from_cbor(await self._transport.call("AdminService", "import-chunk", req.to_cbor()))

    async def finish_import(self, req: FinishImportRequest) -> ImportResult:
        """finish-import"""
        return ImportResult.from_cbor(await self._transport.call("AdminService", "finish-import", req.to_cbor()))

    async def cancel_import(self, req: CancelImportRequest) -> Ok:
        """cancel-import"""
        return Ok.from_cbor(await self._transport.call("AdminService", "cancel-import", req.to_cbor()))
    ...
    async def list_content_reports(self, req: Page) -> ListContentReportsResponse:
        """list-content-reports"""
        return ListContentReportsResponse.from_cbor(await self._transport.call("AdminService", "list-content-reports", req.to_cbor()))

    async def update_content_report_status(self, req: UpdateContentReportStatusRequest) -> ContentReport:
        """update-content-report-status"""
        return ContentReport.from_cbor(await self._transport.call("AdminService", "update-content-report-status", req.to_cbor()))
