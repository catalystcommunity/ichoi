...
echo "================================================"
echo "Ichoi Server Build and Deploy (multi-arch)"
echo "================================================"

# The server target lives under server/ (its Dockerfile + build context + version file).
...
# amd64 + arm64 are both release targets (DESIGN Sec.12); arm64 (Raspberry Pi
# satellites) is first-class. buildkit produces a single multi-arch manifest list.
PLATFORMS="linux/amd64,linux/arm64"

echo ""
echo "================================================"
echo "Building and pushing to internal registry (${PLATFORMS})"
echo "================================================"
buildctl build \
